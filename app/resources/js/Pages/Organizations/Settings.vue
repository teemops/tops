...
const { canManageSettings, canManageMembers, canListMembers, canInviteMembers, canDeleteOrganization, getUserRole } = useOrganizationPermissions();
...
const canDelete = computed(() => {
    ...
    return (
        ...
        !organization.value.is_default &&
        (organization.value.aws_accounts_count || 0) === 0
    );
});
...
<template>
    <SidebarAppLayout>
        ...
        <div class="py-6">
            <div class="max-w-3xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div class="mb-8">
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">Manage your organization details and team
                    </p>
                ...
                <!-- Tabs -->
                <div v-if="organization && canManageSettings"
                ...
                <!-- General Tab -->
                <div v-if="activeTab === 'general' && organization && canManageSettings" class="space-y-6">
                    <!-- Settings Form -->
                    <div
                        ...
                        <form @submit.prevent="handleSubmit" class="px-6 py-6 space-y-6">
                            <div>
                                ...
                                <TextInput id="name" v-model="name" type="text" class="mt-1 block w-full" required />
                            ...
                            <div
                                ...
                                <button type="button" @click="router.visit(route('organizations.index'))"
                    ...
                    <!-- Danger Zone -->
                    <div v-if="organization && canDelete"
                        ...
                        <div class="px-6 py-6">
                            <div class="flex items-center justify-between">
                                <div>
                                    <h3 class="text-sm font-medium text-gray-900 dark:text-white">Delete organization
                                    </h3>
                                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                        Once deleted, this organization and all its data cannot be recovered. This
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
                                    ...
                                    <p v-else-if="(organization.aws_accounts_count || 0) > 0">
                                        This organization has {{ organization.aws_accounts_count }} AWS account(s).
                                        Please remove all AWS accounts before deleting this organization.
                                    </p>
                                </div>
                            </div>
                        </div>
        ...
        <div v-if="showDeleteModal" class="fixed z-10 inset-0 overflow-y-auto" @click.self="showDeleteModal = false">
